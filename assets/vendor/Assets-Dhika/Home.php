        ...
        <div class="container-fluid">
                <nav class="navbar navbar-expand-lg navbar-dark bg-dark fixed-top">
                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        ...
                        <img src="images/png/2.png" width="30" height="30" class="d-inline-block align-top my-2 my-sm-0" alt=""></a></li>
                    ...
                    <div class="col-sm-2 textStyle">
                        <a href=".....">
                            <div class="card mb-3 coba">
                                ...
                                <div class="card-body">
                                    <p class="card-text">....</p>
                                    <p style="color: #d71149;">Rp.</p>
                                    <p class="card-text"><small class="text-muted">ditambahkan pada ...date..</small></p>
                                    </p>
                                </div>
                            </div>
                        </a>
