<div class="container" style="margin-top:100px;">
		...
		<div class="card">
			  ...
			  <h3 class="card-header text-center">Isi Data Pemesan</h3>
			  ...
			  <div class="card-body">
				<form method="post" action="<?php echo base_url(). 'transaksi/tambah_data_pesanan' ?>">
				  ...
				  <div class="form-group">
				    ...
				    <input type="Email" class="form-control" id="disabledTextInput" name="email" placeholder="Masukkan Email yang Terdaftar...">
				  </div>
